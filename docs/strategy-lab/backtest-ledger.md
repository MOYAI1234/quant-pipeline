...
| 2026-06-23 | `adaptive_exposure_guard` 批量筛选 | 本地 simulator + TuShare 交集 CSV | 2017-08-03 至 2021-12-31 | 7 ETF 核心池，10/20 日评估，单 ETF，中期趋势、趋势广度、市场趋势强度分层仓位，10 万本金，最低佣金 5 元，滑点 0.10%，成交量参与率 5% | 最优回撤候选 +5.69% | 12.57% | 年化成交额/初始资金 431.78%，年化费用/初始资金 0.1494%，单日最多成交 2 笔，纯现金日 65.18% | `watchlist` | 仓位分层明显降低回撤和费用，但年化仍低于 6%，暂不准备聚宽脚本 |
| 2026-06-23 | `adaptive_exposure_guard` 批量筛选 | 本地 simulator + TuShare 交集 CSV | 2022-01-01 至 2026-06-19 | 同上，样本外复验 | 最优回撤候选 +3.33% | 9.61% | 年化成交额/初始资金 411.64%，年化费用/初始资金 0.1387%，单日最多成交 2 笔，纯现金日 76.07% | `watchlist` | 样本外回撤更稳但收益不足，后续需要补恢复确认或更清晰的 ETF 池 |
...
| P0 | ETF 趋势防守/核心池轮动新候选 | 本地 | 当前趋势防守和仓位分层仍未出 `PASS`，下一轮需要换 ETF 池或补恢复确认 |
